...
function styleInfo(feature) {
    return {
        color: chooseColor(feature.geometry.coordinates[1]),
        radius: chooseRadius(feature.properties.mag), //sets radius based on magnitude 
        fillColor: chooseColor(feature.geometry.coordinates[1]) //sets fillColor based on the depth of the earthquake
    }
};
...
d3.json(url).then(function (data) { //pull the earthquake JSON data with d3
    ...
    //this function pulls the tectonic plate data and draws a blue line over the plates
